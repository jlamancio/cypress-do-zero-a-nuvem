/// <reference types="cypress"/>
  ...
  it('exibe e ocukta as mensagens de sucesso e erro utilizando : .invoke', () => {
    cy.get('.success')
  ...
  it('preenche o campo da área de texto usando o comando invoke', () => {
    cy.get('#open-text-area')
      .invoke('val','Teste de utilização do comando .invoke')
      .should('have.value', 'Teste de utilização do comando .invoke');
 
  })

  it('faz uma requisição htpp', () => {
    // ~ as requisições criadas via Postman.
